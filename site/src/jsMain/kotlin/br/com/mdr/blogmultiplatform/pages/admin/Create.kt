...
import br.com.mdr.blogmultiplatform.models.Category
import br.com.mdr.blogmultiplatform.models.EditorKey
import br.com.mdr.blogmultiplatform.models.Theme
import br.com.mdr.blogmultiplatform.styles.EditorKeyStyle
                ...
                SimpleGrid(numColumns = numColumns(base = 1, sm = 3)) {
                    ...
                    Row(
                        ...
                        Switch(
                            ...
                            checked = !imageUrlSwitch,
                            onCheckedChange = { imageUrlSwitch = !it },
                            size = SwitchSize.MD
                        )
                        SpanText(
                            modifier = Modifier
                    ...
                    EditorControls(
                        ...
                        isPreviewClicked = editorIsVisible,
        ...
        Input(
            ...
            attrs = Modifier
                ...
                .toAttrs {
                    ...
                    attr("disabled", thumbnailInputDisabled.toString())
                }
        )
        Button(
            attrs = Modifier
            ...
            Box(contentAlignment = Alignment.CenterEnd) {
                Button(
                    attrs = Modifier
                        ...
                        .height(54.px)
                        .margin(left = if (breakpoint < Breakpoint.SM) 12.px else 0.px)
                        .padding(leftRight = 24.px)
                        .borderRadius(4.px)
                        .backgroundColor(Theme.LightGray.rgb)
